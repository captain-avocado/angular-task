...
let InfoService = class InfoService {
    ...
    getParam(paramName = 'access_token') {
        const url = window.location.href;
        let paramValue;
        if (url.includes('#')) {
            const httpParams = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpParams"]({ fromString: url.split('#')[1] });
    ...
    getFriends() {
        ...
        const url = this.friendsUrl + `&user_id=${this.USER_ID}&access_token=${this.TOKEN}&v=5.101`;
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(result => result.response), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(_ => console.log('fetched heroes')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('getHeroes', [])));
    }
};
